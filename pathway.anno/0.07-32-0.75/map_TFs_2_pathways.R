...
#pathway_ids <- paste(1:length(pathway_names), sep = '') 
...
sum(TFsWith_singleAnnotedPathway$pathway_id==2) # 15 Cell cycle/Cellular senescence  
sum(TFsWith_singleAnnotedPathway$pathway_id==3) # 6 JAK-STAT
sum(TFsWith_singleAnnotedPathway$pathway_id==4) # 3 MAPK
sum(TFsWith_singleAnnotedPathway$pathway_id==5) # 10 p53
sum(TFsWith_singleAnnotedPathway$pathway_id==6) # 3 PI3k-Akt
sum(TFsWith_singleAnnotedPathway$pathway_id==7) # 12 None
